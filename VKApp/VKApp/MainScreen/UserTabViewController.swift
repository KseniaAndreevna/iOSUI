...
class UserTabViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "ShowFriendSegue",
            ...
            let userViewController = segue.destination as? UserTabViewController {
            let selectedFriend = addedFriends[cellIndexPath.row]
                
            print(#function)
            print(userViewController.description + " " + selectedFriend.firstName)
            //userViewController.displayedFriends = selectedFriend
      }
   }
...
extension UserTabViewController: UITableViewDataSource {
...
extension UserTabViewController: UITableViewDelegate {
